							...
							<tbody>
								...
								<c:forEach items="${myogg}" var="item">
									...
									<tr>
										...
										<td>
											<p>${item.disponibilita}</p>
										</td>
										<td>
											<p>${item.luogoRitiro}</p>
										</td>
										<td>
											<p>${item.idPrenotante}</p>
										</td>

										<td><input type="hidden" name="idoggetto"
											value="${item.idOggetto}"> <input type="submit"
											class="btn_3" value="Elimina"></td>
									</tr>
									</form>
								</c:forEach>
